(function() {
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce(function( accumulator, currentValue ){
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3.reduceRight(function( accumulator, currentValue ){
    return ( accumulator + 1 ) * currentValue;
  }, 0);
  ...
  */
  ...
  var name = [ 'Ru','an' ];
  var reducePName = name.reduce(function( accumulator, currentValue ){
    return accumulator + 'P' + currentValue;
  }, '');
  console.log( reducePName );
  /*
  ...
  */
  ...
  console.log( 'O objeto "não existe", devido ao parametro passado ao indexOf criar um novo objeto na memoria');
  /*
