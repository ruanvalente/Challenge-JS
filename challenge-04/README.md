...
console.log( isTruthy( 1.90 ));
console.log( isTruthy( {} ));
console.log( isTruthy( function() {} ));
console.log( isTruthy( { nome: 'JS-Ninja' } ));
console.log( isTruthy( "Ruan Valente" ));
console.log( isTruthy( [] ));
console.log( isTruthy( [ 1, 23,4,5 ] ));
...
carro.adicionarPessoas = function( numeroPessoa ) {
  var totalPessoas = carro.quantidadePessoas + numeroPessoa;
  ...
  if ( totalPessoas > carro.assentos ) {
    return 'Só cabem mais '+ pessoasQueCabem+' '+pessoa+'!'
  }
